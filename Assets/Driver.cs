...
public class NewBehaviourScript : MonoBehaviour
{
    ...
    [SerializeField] float r_factor=0.5f;
    [SerializeField] float t_factor=0.5f;
    void Start()
    {
    ...
    void Update()
    {
      float RoteVal = Input.GetAxis("Horizontal")* r_factor *-1;
      transform.Rotate(0,0,RoteVal);
      // I need to add translations to my object
      float TransVal = Input.GetAxis("Vertical")* t_factor;
